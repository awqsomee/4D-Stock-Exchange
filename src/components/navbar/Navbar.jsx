                  ...
                  <div className="navbar__wallet">
                    <NavLink to="/wallet">
                      <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_903_4383)">
                        <path d="M20.1923 25H4.80769C2.11538 25 0 22.8778 0 20.1767V6.67145C0 6.09265 0.384615 5.70679 0.961538 5.70679H20.1923C22.8846 5.70679 25 7.82904 25 10.5301V20.1767C25 22.8778 22.8846 25 20.1923 25ZM1.92308 7.63611V20.1767C1.92308 21.8166 3.17308 23.0707 4.80769 23.0707H20.1923C21.8269 23.0707 23.0769 21.8166 23.0769 20.1767V10.5301C23.0769 8.89017 21.8269 7.63611 20.1923 7.63611H1.92308Z" fill="white"/>
                        <path d="M22.1154 7.6361C21.5385 7.6361 21.1538 7.25024 21.1538 6.67144V3.97039C21.1538 3.29513 20.9615 2.61986 20.3846 2.13753C19.9038 1.75167 19.3269 1.6552 18.75 1.84813L2.69231 5.61031C2.21154 5.70678 1.92308 6.09264 1.92308 6.57497C1.92308 7.15377 1.53846 7.53963 0.961538 7.53963C0.384615 7.53963 0 7.15377 0 6.57497C0 5.22445 0.961539 4.06686 2.21154 3.77746L18.3654 0.111745C19.5192 -0.177654 20.6731 0.111745 21.6346 0.787008C22.5962 1.6552 23.1731 2.8128 23.0769 4.06686V6.67144C23.0769 7.25024 22.6923 7.6361 22.1154 7.6361Z" fill="white"/>
                        <path d="M24.0386 19.2119H17.3078C15.1924 19.2119 13.4617 17.4755 13.4617 15.3533C13.4617 13.231 15.1924 11.4946 17.3078 11.4946H24.0386C24.6155 11.4946 25.0001 11.8805 25.0001 12.4593V18.2473C25.0001 18.8261 24.6155 19.2119 24.0386 19.2119ZM17.3078 13.424C16.2501 13.424 15.3847 14.2921 15.3847 15.3533C15.3847 16.4144 16.2501 17.2826 17.3078 17.2826H23.0771V13.424H17.3078Z" fill="white"/>
                        </g>
                        <defs>
                ...
                {isAuth && (
                  <div className="navbar__portfolio">
                    <NavLink to="/portfolio">
                      ...
                      <path d="M23.3654 13.3997H4.5254C4.16556 13.3997 3.8728 13.1069 3.8728 12.7471C3.8728 12.3872 4.16556 12.0945 4.5254 12.0945H23.3654C23.7252 12.0945 24.018 12.3872 24.018 12.7471C24.018 13.1069 23.7252 13.3997 23.3654 13.3997Z" fill="white"/>
                      <path d="M16.8944 16.5712H11.0027C10.6429 16.5712 10.3501 16.2784 10.3501 15.9186V12.8874C10.3501 12.5275 10.6429 12.2348 11.0027 12.2348C11.3625 12.2348 11.6553 12.5275 11.6553 12.8874V15.266H16.2357V12.7471C16.2357 12.3872 16.5284 12.0945 16.8883 12.0945C17.2481 12.0945 17.5409 12.3872 17.5409 12.7471V15.9186C17.547 16.2784 17.2542 16.5712 16.8944 16.5712Z" fill="white"/>
                      <path d="M17.3823 6.30032C16.9309 6.30032 16.565 5.93437 16.565 5.48304V4.28153C16.565 2.82386 15.3818 1.64064 13.9241 1.64064C12.4664 1.64064 11.2832 2.82386 11.2832 4.28153V5.48304C11.2832 5.93437 10.9173 6.30032 10.466 6.30032C10.0146 6.30032 9.64868 5.93437 9.64868 5.48304V4.28153C9.64868 1.9212 11.5699 0 13.9302 0C16.2905 0 18.2117 1.9212 18.2117 4.28153V5.48304C18.1995 5.93437 17.8336 6.30032 17.3823 6.30032Z" fill="white"/>
                      <path d="M25.3903 25H2.45792C1.10393 25 0 23.9022 0 22.5421V7.12369C0 5.7697 1.10393 4.66577 2.45792 4.66577H25.3903C26.7443 4.66577 27.8482 5.7697 27.8482 7.12369V22.5482C27.8482 23.9022 26.7443 25 25.3903 25ZM2.45792 6.30032C2.00659 6.30032 1.64064 6.66626 1.64064 7.11759V22.5421C1.64064 22.9934 2.00659 23.3594 2.45792 23.3594H25.3903C25.8417 23.3594 26.2076 22.9934 26.2076 22.5421V7.12369C26.2076 6.67236 25.8417 6.30642 25.3903 6.30642C25.3903 6.30032 2.45792 6.30032 2.45792 6.30032Z" fill="white"/>
                      </g>
                      <defs>
