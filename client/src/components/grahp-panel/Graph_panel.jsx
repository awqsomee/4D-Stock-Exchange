  ...
  return (
    <div>
      <div className="selectors">
        <ButtonSwith className={buttDay} onClick={() => {
        ...
        <ButtonSwith className={buttWeek} onClick={() => {
        ...
        <ButtonSwith className={buttMonth} onClick={() => {
        ...
        <ButtonSwith className={buttYear} onClick={() => {
        ...
        <ButtonSwith className={buttAll} onClick={() => {
