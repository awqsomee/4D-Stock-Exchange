  ...
  return (
      <div className='stock'>
            ...
            <div className='stock__counter'>
                <div className='stock__counter__less'> <img src={Less} alt="less_img" className="less_img"></img> </div>
                <div className='count'>1</div>
                <div className='stock__counter__more'> <img src={More} alt="more_img" className="more_img"></img> </div>
            </div>
